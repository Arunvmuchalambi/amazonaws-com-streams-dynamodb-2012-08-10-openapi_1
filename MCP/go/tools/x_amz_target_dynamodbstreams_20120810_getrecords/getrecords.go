...
func GetrecordsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetRecordsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDBStreams_20120810.GetRecords", cfg.BaseURL)
		...
		var result models.GetRecordsOutput
...
func CreateGetrecordsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDBStreams_20120810_GetRecords",
		...
		mcp.WithString("ShardIterator", mcp.Required(), mcp.Description("")),
	)
